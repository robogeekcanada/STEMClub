...
if __name__ == '__main__' :
    ...
    # Read source image.
    im_src = cv2.imread('ROBOGEEK STEM CLUB.jpg');
    size = im_src.shape
    ...
    im_dst = cv2.imread('Toronto billboard.jpg');

    # Get four corners of the billboard
    print ('Click on 4 corners then press Enter')
    ...
    # Display image.
    cv2.imshow("Toronto Billboard", im_dst);
    cv2.waitKey(0);
